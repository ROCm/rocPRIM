...
make -j `nproc` benchmark_device_reduce benchmark_device_scan benchmark_device_merge_sort_block_merge benchmark_device_merge_sort_block_sort benchmark_device_radix_sort_block_sort benchmark_device_radix_sort_onesweep
...
./benchmark/benchmark_device_scan --benchmark_out=./device_scan_$gpu_arch.json --benchmark_out_format=json
./benchmark/benchmark_device_merge_sort_block_merge --benchmark_out=./device_merge_sort_block_merge_$gpu_arch.json --benchmark_out_format=json
./benchmark/benchmark_device_merge_sort_block_sort --benchmark_out=./device_merge_sort_block_sort_$gpu_arch.json --benchmark_out_format=json
./benchmark/benchmark_device_radix_sort_block_sort --benchmark_out=./device_radix_sort_block_sort_$gpu_arch.json --benchmark_out_format=json
./benchmark/benchmark_device_radix_sort_onesweep --benchmark_out=./device_radix_sort_onesweep_$gpu_arch.json --benchmark_out_format=json

mkdir -p ../configs

#Generate configuration based on the output of the benchmark
python3 ../scripts/autotune/create_optimization.py  --benchmark_files \
./device_reduce_$gpu_arch.json \
./device_scan_$gpu_arch.json \
./device_merge_sort_block_merge_$gpu_arch.json \
./device_merge_sort_block_sort_$gpu_arch.json \
./device_radix_sort_block_sort_$gpu_arch.json \
./device_radix_sort_onesweep_$gpu_arch.json \
-p  ../configs
