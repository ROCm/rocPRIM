...
.. doxygenfunction:: get_bit (int x, int i)
.. doxygenfunction:: bit_count (unsigned int x)
.. doxygenfunction:: bit_count (unsigned long long x)

Warp size
---------

.. doxygenfunction:: warp_size ()
.. doxygenfunction:: host_warp_size ()
.. doxygenfunction:: device_warp_size ()
...
.. doxygenfunction:: wave_barrier ()

Active threads
--------------

.. doxygenfunction:: ballot (int predicate)
.. doxygenfunction:: masked_bit_count (lane_mask_type x, unsigned int add=0)
