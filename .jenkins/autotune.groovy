...
def runCI = 
{
    ...
    def testCommand = {
        ...
        withCredentials([context.usernameColonPassword(credentialsId: 'ab8d4444-4620-4189-a9ce-c16035c854dd', variable: 'GIT_USERPASS')]) {
            def command = """#!/usr/bin/env bash
            set -x
            cd ${project.paths.project_build_prefix}
            ${auxiliary.gfxTargetParser()}
            ./CreateRocLibPR.py -l rocPRIM -c \$GIT_USERPASS \\
