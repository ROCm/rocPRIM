...
set(PROJECT_WRAPPER_MAIN_INC_GUARD      "${include_guard}ROCPRIM_WRAPPER_MAIN_INC")
set(PROJECT_WRAPPER_BLOCK_GUARD     	"${include_guard}ROCPRIM_WRAPPER_BLOCK_INC")
set(PROJECT_WRAPPER_DETAIL_GUARD        "${include_guard}ROCPRIM_WRAPPER_DETAIL_INC")
set(PROJECT_WRAPPER_DEVICE_GUARD        "${include_guard}ROCPRIM_WRAPPER_DEVICE_INC")
set(PROJECT_WRAPPER_INTRINSICS_GUARD    "${include_guard}ROCPRIM_WRAPPER_INTRINSICS_INC")
set(PROJECT_WRAPPER_ITERATOR_GUARD      "${include_guard}ROCPRIM_WRAPPER_ITERATOR_INC")
set(PROJECT_WRAPPER_TYPES_GUARD         "${include_guard}ROCPRIM_WRAPPER_TYPES_INC")
set(PROJECT_WRAPPER_THREAD_GUARD        "${include_guard}ROCPRIM_WRAPPER_THREAD_INC")
set(PROJECT_WRAPPER_WARP_GUARD          "${include_guard}ROCPRIM_WRAPPER_WARP_INC")
set(PROJECT_WRAPPER_BLK_DET_GUARD       "${include_guard}ROCPRIM_WRAPPER_BLK_DET_INC")
set(PROJECT_WRAPPER_DEV_DET_GUARD       "${include_guard}ROCPRIM_WRAPPER_DEV_DET_INC")
set(PROJECT_WRAPPER_DEV_SPE_GUARD       "${include_guard}ROCPRIM_WRAPPER_DEV_SPE_INC")
set(PROJECT_WRAPPER_ITE_DET_GUARD       "${include_guard}ROCPRIM_WRAPPER_ITE_DET_INC")
set(PROJECT_WRAPPER_WAR_DET_GUARD       "${include_guard}ROCPRIM_WRAPPER_WAR_DET_INC")
...
function (package_gen_bkwdcomp_hdrs)
	...
	foreach(include_file ${include_files})
		...
		set(include_guard "${PROJECT_WRAPPER_MAIN_INC_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_BLOCK_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_DETAIL_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_DEVICE_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_INTRINSICS_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_ITERATOR_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_TYPES_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_THREAD_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_WARP_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_BLK_DET_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_DEV_DET_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_DEV_SPE_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_ITE_DET_GUARD}_${INC_FILE_NAME}_HPP")
	...
	foreach(include_file ${include_files})
		...
		get_filename_component(file_name_we ${include_file} NAME_WE)
		string(TOUPPER ${file_name_we} INC_FILE_NAME)
		set(include_guard "${PROJECT_WRAPPER_WAR_DET_GUARD}_${INC_FILE_NAME}_HPP")
