...
* Added a parallel `nth_element` device funcion similar to `std::nth_element`, this function rearranges elements smaller than the n-th before and bigger than the n-th after the n-th element.
